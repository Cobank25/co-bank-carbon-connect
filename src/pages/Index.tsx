        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-20 items-start">
            ...
            <div className="order-1 lg:order-2">
              ...
              <p className="text-[15px] text-[#121417]/40 leading-[1.7] mb-10">
                A CoBank oferece praticidade e acessibilidade a negócios que buscam o ingresso ao mercado de carbono, mantendo o compromisso com a agenda ESG e atualidades. Se comprometendo com:
              </p>
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="size-10 shrink-0 rounded-lg bg-[#121417]/[0.04] flex items-center justify-center">
